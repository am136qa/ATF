...
public class APIConstants {
    public static final String baseURI = RestAssured.baseURI = "http://hrm/api";
    ...
    public static final String PARTIAL_UPDATE_EMPLOYEE_URI = baseURI+"/updatePartialEmplyeesDetails.php";
